document.addEventListener("DOMContentLoaded", () => {
    ...
    console.log("tet3t3t3tee")
    // Fetch dealer-specific properties
    async function fetchDealerProperties(dealer_id) {
        try {
            const response = await fetch(`http://127.0.0.1:5000/api/properties/${dealer_id}`);  // API URL directly fetching dealer's properties
...
console.log("testedddd")
        ...
        <div class="property-item rounded overflow-hidden m-2">
            <div class="position-relative overflow-hidden">
                <a href="individualProp.html?house_id=${property.house_id}">
                    <img class="img-fluid" src="${property.image_url}" alt="Property Imagee" style="max">
                </a>
  ...
  <p><i class="fa fa-map-marker-alt text-primary me-2"></i>Location</p>
    ...
    // Initialize by fetching dealer properties
    fetchDealerProperties(user_id);
...
frontend/dealer/js/bookings.js